...
export function buildCommercialSkillDoctrine(locale: SupportedLocale): SkillDoctrine {
  ...
  return {
    version: "commercial-seo-skill-doctrine-1.0.0",
    sources: [
      {
        name: "codex-seo",
    ...
    scoringRubric: [
      ...
      { dimension: "Internal authority", weight: 12, passSignal: "Internal links are contextual and support the next shopper step." },
